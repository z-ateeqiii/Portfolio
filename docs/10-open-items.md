...
- [ ] **Experience is not rendered anywhere public yet.** Four roles are about to be seeded, but `02`'s IA has no Experience page — `02` §13 says this kind of supporting content lives inside Work/About rather than as its own destination. Where it surfaces (probably `/about`) is an open design decision, not an oversight.
