  ...
  template: `
    <div class="p-8">
      ...
      >
        ...
        <label class="mt-3 inline-block cursor-pointer rounded-sm border border-fg/24 px-4 py-2 text-caption text-fg">
          Choose files
      ...
      @if (pending().length) {
        <div class="mt-8 max-w-3xl">
          ...
          @for (item of pending(); track item.publicId) {
            <div class="mt-4 flex gap-4 rounded-md border border-fg/24 p-4">
              ...
              <div class="min-w-0 flex-1 space-y-2">
                <label class="block">
                  ...
                  <input
                    ...
                    class="mt-1 w-full rounded-sm border border-fg/24 bg-surface px-3 py-2 text-body text-fg"
                  />
                </label>
                <label class="block">
            ...
            <div class="mt-4 flex gap-4 rounded-md border border-fg/12 p-4">
              ...
              <div class="min-w-0 flex-1 space-y-2">
                <input
                  ...
                  class="w-full rounded-sm border border-fg/24 bg-surface px-3 py-2 text-caption text-fg"
                />
                <input
                  [name]="'c' + item.id"
                  [ngModel]="item.caption ?? ''"
                ...
                <div class="flex flex-wrap items-center gap-4">
                  <label class="flex items-center gap-2 text-caption text-fg-muted">
                    ...
                    <input
                      ...
                      class="w-20 rounded-sm border border-fg/24 bg-surface px-2 py-1 text-caption text-fg"
                    />
                  </label>
                  <label class="flex items-center gap-2 text-caption text-fg-muted">
                    <input
